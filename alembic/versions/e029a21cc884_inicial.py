...
Revision ID: e029a21cc884
Revises: 
Create Date: 2023-03-07 13:30:46.397731
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_produtos_detalhes"), "produtos", ["detalhes"], unique=False
    )
    op.create_index(
        op.f("ix_produtos_disponivel"), "produtos", ["disponivel"], unique=False
    )
